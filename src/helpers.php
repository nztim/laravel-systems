...
if (!function_exists('log_info')) {
    ...
    {
        app(\NZTim\Logger\Logger::class)->info($channel, $message, $context);
    }
}
...
if (!function_exists('log_warning')) {
    ...
    {
        app(\NZTim\Logger\Logger::class)->warning($channel, $message, $context);
    }
}
...
if (!function_exists('log_error')) {
    ...
    {
        app(\NZTim\Logger\Logger::class)->error($channel, $message, $context);
    }
}
