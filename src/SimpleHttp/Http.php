...
class Http
{
    ...
    public function withBasicAuth(string $username, string $password): Http
    {
        $this->options['auth'] = [$username, $password];
        return $this;
    }

    public function withDigestAuth(string $username, string $password): Http
    {
        $this->options['auth'] = [$username, $password, 'digest'];
        return $this;
    }

    public function timeout(int $seconds): Http
    {
    ...
    private function mergeUrlQuery(string $url): void
    {
